...
- Public imports: `from bandl.v2 import Bandl, OHLCV, Interval`.
...
2. **Sync-first HTTP** — `httpx` synchronous client keeps the first V2 slice small; streaming/WebSockets can add an async layer later without changing models.
