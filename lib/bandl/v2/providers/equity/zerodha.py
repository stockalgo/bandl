...
from bandl.v2.exceptions import AuthenticationError, ProviderError, SymbolNotFoundError
...
def _parse_kite_timestamp(raw: str) -> datetime:
    """Parse Kite candle timestamp to UTC (handles ``+0530`` style offsets)."""
    s = raw.strip()
